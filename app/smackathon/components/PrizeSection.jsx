...
export default function Prize() {
  return (
    <>
      ...
      <Image src="/images/prize/transition-nether-new.png" width={1440} height={348} className="w-full bg-cover" />
    </>
  );
}
...
//   const images = [
//     "/images/prize/ores.png",
//     "/images/prize/diamond.png",
//     "/images/prize/gold.png",
//   ];

//   return (<>
//     <img src="/images/prize/temp4.png" alt="" />
//     <div className="bg-[url('/images/prize/cave3.avif')] w-full bg-cover flex flex-col items-center">
//       <h2 className="text-5xl mt-16 text-center text-white font-bold">
//         Cash Prizes
//       </h2>
//       <div className="flex flex-col gap-40 lg:flex-row py-32">
//         <div className="flex flex-col items-center gap-10 order-1 md:order-0">
//           <span className="font-semibold text-white text-xl">Prize 2</span>

//           <div className="bg-[radial-gradient(circle,_rgba(255,_215,_0,_0.6),_rgba(255,_215,_0,_0)_75%)] p-14">
//             <motion.div
//               animate={{
//                 y: [10, -10],
//                 transition: {
...
//                 width={200}
//                 height={200}
//                 src={width < 700 ? images[0] : images[1]}
//               />
//             </motion.div>
//           </div>
//           <span className="font-medium text-white text-xl">5000</span>
...
//                 width={300}
//                 height={300}
//                 src={width < 700 ? images[1] : images[0]}
//               />
//             </motion.div>
//           </div>
...
//           <div className="bg-[radial-gradient(circle,_rgba(255,_215,_0,_0.6),_rgba(255,_215,_0,_0)_75%)] p-16">
//             <motion.div
//               animate={{
//                 y: [10, -10],
//                 transition: {
...
//               whileHover={{ scale: 1.1 }}
//             >
//               <Image width={200} height={200} src={images[2]} />
//             </motion.div>
//           </div>
