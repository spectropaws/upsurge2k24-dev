...
const Cards = () => {
 ...
 {/* Core Team */}
 <h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>CORE TEAM</h1>
...
<div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
  ...
  <StarsBackground>
 {/* Technical Team */}
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>TECHNICAL TEAM</h1>
<div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
  ...
  <StarsBackground>
 {/* Design Team */}
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>DESIGN TEAM</h1>
...
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>EVENT MANAGEMENT TEAM</h1>
<div className={`${styles1.cards} mb-32 mt-20 ml-[0.5rem]`}>
  ...
  <StarsBackground>
    {/* Cultural Team  */}
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>CULTURAL TEAM</h1>
<div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
{data[4].map((cardClass, index) => (
  ...
  <StarsBackground>
    {/* Sponsership team  */}
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>SPONSERSHIP TEAM</h1>
<div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
  ...
  <StarsBackground>
    {/* Database team  */}
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>DATABASE TEAM</h1>
<div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
{data[6].map((cardClass, index) => (
  ...
  <StarsBackground>
    {/* Publicity Team  */}
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>PUBLICITY TEAM</h1>
<div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
  ...
  <StarsBackground>
    {/* Literature Team  */}
<h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>LITERATURE TEAM</h1>
<div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
{data[8].map((cardClass, index) => (
    ...
    <StarsBackground>
    {/* Art team  */}
  <h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>ART TEAM</h1>
  <div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
  {data[9].map((cardClass, index) => (
    ...
    <StarsBackground>
    {/* Sports Team  */}
    <h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>SPORTS TEAM</h1>
    <div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
...
<StarsBackground>
    {/* Social Media Team  */}
    <h1 className={`${styles1.teamName} text-white text-center font-bold md:text-5xl text-3xl pt-20`}>SOCIAL MEDIA TEAM</h1>
    <div className={`${styles1.cards} mb-28 mt-28 ml-[0.5rem]`}>
